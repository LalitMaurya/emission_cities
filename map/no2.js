...
function createLegend(){
  ...
  legend.append("text").text("NO2").attr("x",75).attr("y",83);
...
function setProbeContent(d){
  ...
  var html = "<strong>" + d.CITY + "</strong><br/>" + " NO2' Annual mean: " +
            "<strong>" +format( Math.abs( val ) ) + "</strong>"+ ( val < 0 ? "lost" : " ug/m3" ) + "<br/>" +
            "<span>Concentration exceeding NAAQS of 40 ug/m3" + "</span>";
  probe
    .html( html );
}
